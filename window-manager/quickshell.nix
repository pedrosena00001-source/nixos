...
ShellRoot {
    ...
    // Processo único e reutilizável para trocar de workspace (evita leak de criar um Process por clique)
    Process {
    ...
    // Timer for window/layout/workspace (intervalo aumentado de 200ms pra 600ms — reduz carga)
    Timer {
        interval: 600
        running: true
        repeat: true
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Image {
                            anchors.fill: parent
                            // caminho corrigido pro usuário pedro (ajuste o nome do arquivo do ícone se for diferente)
                            source: "file://" + Quickshell.env("HOME") + "/.config/quickshell/icons/icon.png"
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                anchors.fill: parent
                                onClicked: {
                                    workspaceSwitchProc.command = ["swaymsg", "workspace", String(index + 1)]
